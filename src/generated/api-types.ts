...
export interface paths {
    ...
    "/api/v1/monthly-report/start": {
         ...
         *     비동기로 처리되기 때문에, id로 월간 리포트 조회 API를 폴링하여 상태를 확인할 수 있습니다.
         */
        post: operations["startMonthlyReport_1"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/moderation/reports": {
        ...
        /**
         * 신고 API
         * @description 공유글 또는 댓글/대댓글을 신고합니다.
         *
         *     요청 필드:
    ...
    "/api/v1/feed/{dailyReportId}/likes": {
        ...
        /**
         * 게시글 좋아요 리스트
         * @description 게시글에 좋아요를 누른 사용자 목록을 조회합니다.
         *
        ...
        /**
         * 게시글 좋아요
         * @description 친구의 공유 게시글에 좋아요를 누릅니다.
         *
         *     - 본인의 게시글에는 좋아요 불가 (400)
         *     - 이미 좋아요한 경우 204 반환 (멱등)
         */
        post: operations["likeReport"];
        /** 게시글 좋아요 취소 */
        delete: operations["unlikeReport"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/api/v1/comments": {
        ...
        /**
         * 댓글 목록 조회
         * @description 피드 게시글의 댓글 목록을 커서 기반으로 최신순 조회합니다.
         *
         *     요청 파라미터:
    ...
    "/api/v1/comments/{commentId}/sub-comments": {
        ...
        /**
         * 대댓글 목록 조회
         * @description 특정 댓글의 대댓글 목록을 커서 기반으로 최신순 조회합니다.
         *
         *     요청 파라미터:
         ...
         */
        get: operations["getSubComments"];
        put?: never;
        /**
         * 대댓글 작성
         * @description 특정 댓글에 대댓글을 작성합니다.
         *
         ...
         */
        post: operations["createSubComment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/comments/{commentId}/likes": {
        ...
        /**
         * 댓글/대댓글 좋아요
         * @description 댓글 또는 대댓글에 좋아요를 누릅니다.
         *
         *     - 본인의 댓글에는 좋아요 불가 (400)
    ...
    "/api/v1/comments/{commentId}": {
        ...
        /**
         * 댓글 수정
         * @description 본인이 작성한 댓글/대댓글의 내용을 수정합니다.
         *
    ...
    "/api/v1/monthly-report": {
         ...
         *     styled 렌더링이 가능하다면 ```content``` 사용을 권장합니다.
         */
        get: operations["getMyMonthlyReport_1"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/monthly-report/{id}": {
         ...
         *     styled 렌더링이 가능하다면 ```content``` 사용을 권장합니다.
         */
        get: operations["getMonthlyReportById_1"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/moderation/suspension/status": {
        ...
        /**
         * 소셜 정지 상태 조회
         * @description 내 소셜 정지 여부와 해제 시각을 반환합니다. (팝업 표시용)
         *
         *     - isSuspended: 정지 중이면 true
         *     - expiresAt: 정지 중일 때만 반환 (정지 해제 시각, ISO 8601)
         */
        get: operations["getSuspensionStatus"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        /** @description 신고 요청 — dailyReportId / commentId 중 하나만 필수 */
        ReportContentRequest: {
            /**
             * Format: int64
             * @description 신고할 DailyReport ID (게시글 신고 시 필수)
             * @example 123
             */
            dailyReportId?: number;
            /**
             * Format: int64
             * @description 신고할 Comment ID (댓글/대댓글 신고 시 필수)
             * @example 456
             */
            commentId?: number;
            /**
        ...
        /** @description 전체 리포트 목록 아이템 */
        AllReportItemResponseV2: {
            /**
             * Format: int64
             * @description 리포트 ID
             */
        ...
        /** @description 소셜 정지 상태 응답 */
        SuspensionStatusResponse: {
            /** @description 소셜 정지 여부 */
            isSuspended?: boolean;
            /**
             * Format: date-time
             * @description 정지 해제 시각 (정지 중일 때만 반환)
             */
            expiresAt?: string;
        };
        ...
        FeedListResponse: {
            /** @description 오늘 내 공유 리포트 (미공유 시 null) */
            myReport?: components["schemas"]["FeedResponse"];
            /** @description 친구 피드 목록 */
        ...
        FeedResponse: {
            ...
            isLiked?: boolean;
            /** @description 좋아요가 1개 이상인지 여부 */
            hasLikes?: boolean;
        };
        /** @description 좋아요 리스트 응답 */
        LikeListResponse: {
            /** @description 좋아요 누른 사용자 목록 (최신순, 차단 관계 제외) */
            likers?: components["schemas"]["LikerResponse"][];
        };
        /** @description 좋아요 누른 사용자 */
        LikerResponse: {
            /**
             * Format: int64
             * @description 사용자 ID
        ...
        CommentResponse: {
             ...
             */
            commentId?: number;
            /** @description 작성자 프로필 이미지 URL (canViewContent=false이면 null) */
            authorProfileImageUrl?: string;
            /** @description 작성자 닉네임 (canViewContent=false이면 null) */
            authorNickname?: string;
            /** @description 댓글 내용 (canViewContent=false이면 null) */
            content?: string;
            /**
             * Format: date-time
             * @description 작성 시각 (ISO 8601, 예: 2024-05-11T10:30:00+09:00) — 프론트에서 현재 시각 기준으로 '3분 전' 등으로 변환하여 표시
             */
            createdAt?: string;
            /** @description 내가 좋아요 눌렀는지 여부 */
            isLiked?: boolean;
            ...
            /**
             * Format: int32
             * @description 보이는 대댓글 수 (canViewContent=false이거나 대댓글에서는 null)
             */
            visibleSubCommentCount?: number;
            /** @description 비밀 댓글 여부 */
            isSecret?: boolean;
            /** @description 비밀 댓글 열람 권한 여부 (false이면 authorProfileImageUrl·authorNickname·content가 null) */
            canViewContent?: boolean;
            /** @description 내 댓글 여부 */
            isMine?: boolean;
            /** @description 삭제 가능 여부 (본인 또는 리포트 당사자) */
            canDelete?: boolean;
        };
...
export interface operations {
    ...
    reportContent: {
        ...
        responses: {
            ...
            /**
             * @description - ErrorCode: CONTENT_REPORT_INVALID - 잘못된 신고 요청 (대상 미입력/중복 입력, 기타 사유 미입력 또는 200자 초과)
            ...
            /**
             * @description - ErrorCode: CONTENT_REPORT_ALREADY_EXISTS - 이미 신고한 대상
    ...
    getReportLikers: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["LikeListResponse"];
                };
            };
            /** @description 인증 실패 */
            401: {
            ...
            /** @description ErrorCode: DAILY_REPORT_LIKE_LIST_FORBIDDEN - 본인 게시글 아님 */
            403: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description ErrorCode: DAILY_REPORT_NOT_FOUND */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    likeReport: {
        ...
        responses: {
            ...
            /**
             * @description - ErrorCode: CANNOT_LIKE_OWN_CONTENT - 본인 게시글 좋아요 불가
            ...
            /** @description ErrorCode: AUTH_ACCESS_DENIED - 공유되지 않은 게시글이거나 친구가 아닌 경우 */
            403: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    unlikeReport: {
        ...
        responses: {
            ...
            /** @description ErrorCode: SOCIAL_SUSPENDED - 소셜 정지 중 */
            400: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description ErrorCode: LIKE_NOT_FOUND */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getComments: {
        ...
        responses: {
            ...
            /** @description ErrorCode: AUTH_ACCESS_DENIED - 본인 피드 게시글이 아니거나 친구의 공유 게시글이 아닌 경우 */
            403: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    createComment: {
        ...
        responses: {
            ...
            /**
             * @description - ErrorCode: VALIDATION_FAILED - 내용 누락 또는 500자 초과
             *     - ErrorCode: SOCIAL_SUSPENDED - 소셜 정지 중
             */
            400: {
                headers: {
    ...
    getSubComments: {
        ...
        responses: {
            ...
            /** @description ErrorCode: COMMENT_NOT_TOP_LEVEL - commentId가 대댓글 ID인 경우 (대댓글의 대댓글 불가) */
            400: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description ErrorCode: COMMENT_NOT_FOUND */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    createSubComment: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateSubCommentRequest"];
            };
        };
        responses: {
            /** @description 작성 성공 */
            ...
            /** @description ErrorCode: COMMENT_DELETED - 이미 삭제된 댓글에 대댓글 시도 */
            409: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getCommentLikers: {
        ...
        responses: {
            ...
            /** @description ErrorCode: AUTH_ACCESS_DENIED - 비밀 댓글 열람 권한 없음 또는 피드 접근 권한 없음 */
            403: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    likeComment: {
        ...
        responses: {
            ...
            /**
             * @description - ErrorCode: CANNOT_LIKE_OWN_CONTENT - 본인 댓글 좋아요 불가
             *     - ErrorCode: SOCIAL_SUSPENDED - 소셜 정지 중
             */
            400: {
                headers: {
            ...
            /** @description ErrorCode: AUTH_ACCESS_DENIED */
            403: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    deleteComment: {
        ...
        responses: {
            ...
            /** @description ErrorCode: AUTH_ACCESS_DENIED - 삭제 권한 없음 */
            403: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description ErrorCode: COMMENT_DELETED - 이미 삭제된 댓글 */
            409: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    updateComment: {
        ...
        responses: {
            ...
            /** @description ErrorCode: AUTH_ACCESS_DENIED - 본인 댓글만 수정 가능 */
            403: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getMyMonthlyReport: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["MyMonthlyReportLookupResponseV2"];
                };
            };
            /** @description 인증 실패 */
            401: {
    ...
    getMonthlyReportById: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["MonthlyReportResponseV2"];
                };
            };
    ...
    getSuspensionStatus: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["SuspensionStatusResponse"];
                };
            };
            /** @description 인증 실패 */
            401: {
