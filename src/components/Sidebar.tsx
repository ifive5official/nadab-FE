      ...
      <AnimatePresence>
        {isSidebarOpen && (
          <>
            ...
            {/* 사이드바 */}
            <motion.div
              className="fixed z-5 inset-y-0 top-(--safe-top)! right-0 sm:right-[calc((100vw-420px)/2)] w-[clamp(calc(320px*0.5),calc((320/390)*100vw),calc(320px*1.2))] sm:w-[320px] bg-surface-base dark:bg-surface-layer-1 px-padding-x-m pt-(--safe-top) pb-(--safe-bottom) flex flex-col"
